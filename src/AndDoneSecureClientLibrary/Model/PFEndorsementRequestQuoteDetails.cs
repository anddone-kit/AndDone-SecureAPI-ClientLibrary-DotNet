...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class PFEndorsementRequestQuoteDetails : IValidatableObject
    {
        ...
        public PFEndorsementRequestQuoteDetails(string commercial = default(string), string coupon = default(string), bool couponInvoicePrinted = default(bool), int crd = default(int), string interval = default(string), int installments = default(int), int programID = default(int), int brokerFee = default(int), string eSignOption = default(string), bool processDownPayment = default(bool), string processDownPaymentNoReason = default(string), string downPaymentMethod = default(string), string downPaymentPaidBy = default(string), PFEndorsementRequestQuoteDetailsRecurringACH recurringACH = default(PFEndorsementRequestQuoteDetailsRecurringACH), string batchID = default(string), bool returnPFA = default(bool), string equalPayments = default(string), int quoteExpirationDays = default(int), bool bypassCADNB = default(bool), bool allowZeroAPR = default(bool), string associatedAccountNumber = default(string), string channel = default(string), string channelVersion = default(string))
        {
