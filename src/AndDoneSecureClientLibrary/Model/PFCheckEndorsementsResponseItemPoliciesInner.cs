...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class PFCheckEndorsementsResponseItemPoliciesInner : IValidatableObject
    {
        ...
        public PFCheckEndorsementsResponseItemPoliciesInner(int policyID = default(int), string companyName = default(string), string policyNumber = default(string), float premium = default(float), string coverageType = default(string), string coverageTypeDescription = default(string), int companyTypeID = default(int))
        {
