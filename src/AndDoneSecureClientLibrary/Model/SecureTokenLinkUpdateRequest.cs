...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class SecureTokenLinkUpdateRequest : IValidatableObject
    {
        ...
        public SecureTokenLinkUpdateRequest(string tokenLinkId = default(string), int expireIn = default(int), ResponseTypeEnum? responseType = default(ResponseTypeEnum?), ExpireInUnitEnum expireInUnit = default(ExpireInUnitEnum), PaymentIntentResponseIntent intent = default(PaymentIntentResponseIntent), PaymentLinkResponseCallbackParameters callBackParameters = default(PaymentLinkResponseCallbackParameters))
        {
