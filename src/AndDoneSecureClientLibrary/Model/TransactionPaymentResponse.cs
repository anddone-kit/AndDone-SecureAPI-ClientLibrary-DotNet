...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class TransactionPaymentResponse : IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "chargeBackAmount", EmitDefaultValue = true)]
