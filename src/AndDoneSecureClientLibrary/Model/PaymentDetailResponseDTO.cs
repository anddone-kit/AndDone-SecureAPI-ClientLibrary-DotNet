...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class PaymentDetailResponseDTO : IValidatableObject
    {
        ...
        public PaymentDetailResponseDTO(string merchantId = default(string), string vendorId = default(string), string vendorName = default(string), string merchantDBAName = default(string), string paymentId = default(string), int checkNumber = default(int), PaymentMethodEnum? paymentMethod = default(PaymentMethodEnum?), float amount = default(float), string bankName = default(string), string bankAccountNumber = default(string), PaymentStatusEnum? paymentStatus = default(PaymentStatusEnum?), PaymentMethodStatusEnum? paymentMethodStatus = default(PaymentMethodStatusEnum?), string remittanceData = default(string))
        {
