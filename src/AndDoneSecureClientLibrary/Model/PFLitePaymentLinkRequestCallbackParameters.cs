...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class PFLitePaymentLinkRequestCallbackParameters : IValidatableObject
    {
        ...
        public PFLitePaymentLinkRequestCallbackParameters(string callbackApiUrl = default(string), string callbackMessage = default(string), string accessKey = default(string), string secretKey = default(string), string referenceNo = default(string), string referenceType = default(string), string transactionId = default(string), int redirectionTime = default(int))
        {
