...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class QuoteResponse : IValidatableObject
    {
        ...
        /// <param name="autopayStatus">The autopayStatus..</param>
        ...
        /// <param name="offerAutoPay">The OfferAutoPay Status..</param>
        ...
        public QuoteResponse(string id = default(string), string quoteKey = default(string), string pFType = default(string), bool isEndorsement = default(bool), string merchantId = default(string), int programId = default(int), string programName = default(string), string paymentIntentId = default(string), string accountNumber = default(string), QuoteStatusEnum? quoteStatus = default(QuoteStatusEnum?), bool isActive = true, float premium = default(float), float tax = default(float), float additionalFees = default(float), float brokerFee = default(float), float downAmount = default(float), float amountFinanced = default(float), float financeCharge = default(float), float totalPayments = default(float), float paymentAmount = default(float), float totalAmount = default(float), int docStamp = default(int), string firstDueDate = default(string), float apr = default(float), int installments = default(int), string batchId = default(string), string autopayStatus = default(string), int paymentsRetained = default(int), float paymentRetainedAmount = default(float), string retailAgentRegisterLoginURL = default(string), string insuredName = default(string), bool isEsignPFA = default(bool), string nextPaymentDueDate = default(string), string lastPaymentDate = default(string), bool isDownPaymentRequired = default(bool), bool isEsignRequired = default(bool), bool isDeleted = default(bool), bool offerAutoPay = default(bool), string createdOn = default(string), string createdBy = default(string), string modifiedOn = default(string), string modifiedBy = default(string), string unSignPFA = default(string), string signPFA = default(string))
        {
            ...
            this.OfferAutoPay = offerAutoPay;
        ...
        /// </summary>
        /// <value>The OfferAutoPay Status.</value>
        [DataMember(Name = "offerAutoPay", EmitDefaultValue = true)]
        public bool OfferAutoPay { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OfferAutoPay: ").Append(OfferAutoPay).Append("\n");
