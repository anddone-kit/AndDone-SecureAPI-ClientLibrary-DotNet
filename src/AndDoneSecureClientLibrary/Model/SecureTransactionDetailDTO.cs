...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class SecureTransactionDetailDTO : IValidatableObject
    {
        ...
        public SecureTransactionDetailDTO(string transactionId = default(string), string traceNumber = default(string), string transactionCode = default(string), TransactionOriginEnum? transactionOrigin = default(TransactionOriginEnum?), TransactionPaymentResponseRefundOrigin refundOrigin = default(TransactionPaymentResponseRefundOrigin), TransactionPaymentResponseBillingContact billingContact = default(TransactionPaymentResponseBillingContact), TransactionPaymentResponseBillingContact shippingContact = default(TransactionPaymentResponseBillingContact), string referenceTransactionId = default(string), string transactionDate = default(string), string merchantId = default(string), string ipAddress = default(string), OperationTypeEnum? operationType = default(OperationTypeEnum?), ChannelTypeEnum? channelType = default(ChannelTypeEnum?), ProcessMethodEnum? processMethod = default(ProcessMethodEnum?), string processorName = default(string), bool isDebit = default(bool), SecureTransactionDetailDTOTenderInfo tenderInfo = default(SecureTransactionDetailDTOTenderInfo), string referenceCustomerId = default(string), string invoiceNo = default(string), string referenceNo = default(string), string remarks = default(string), RecurringTypeEnum? recurringType = default(RecurringTypeEnum?), string recurringId = default(string), int installmentNumber = default(int), int installmentCount = default(int), bool allowDuplicates = default(bool), bool verificationEnabled = default(bool), bool sentSuccessNotification = default(bool), bool sentFailedNotification = default(bool), bool trainingMode = default(bool), string terminalId = default(string), bool isOffline = default(bool), TransactionStatusEnum? transactionStatus = default(TransactionStatusEnum?), PreviousTransactionStatusEnum? previousTransactionStatus = default(PreviousTransactionStatusEnum?), TransactionPaymentResponseTransactionResult transactionResult = default(TransactionPaymentResponseTransactionResult), int level = default(int), string partnerId = default(string), string orderId = default(string), string invoiceId = default(string), string paymentLinkId = default(string), string additionalFields = default(string), string settlementDate = default(string), string issuer = default(string), string paymentReference = default(string), string refundReference = default(string))
        {
        ...
        public TransactionPaymentResponseRefundOrigin RefundOrigin { get; set; }
