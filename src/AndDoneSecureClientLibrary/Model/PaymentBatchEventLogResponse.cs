...
namespace AndDoneSecureClientLibrary.Model
{
    ...
    public partial class PaymentBatchEventLogResponse : IValidatableObject
    {
        ...
        public PaymentBatchEventLogResponse(string id = default(string), string batchId = default(string), string merchantId = default(string), string previousEventStatus = default(string), string eventStatus = default(string), int voidedCount = default(int), float voidedAmount = default(float), string closedOn = default(string), string eventDate = default(string), float closingAmount = default(float), string createdOn = default(string), string createdBy = default(string), string modifiedOn = default(string), string modifiedBy = default(string))
        {
            this.Id = id;
