...
namespace AndDoneSecureClientLibrary.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration(
            ...
            string basePath = "https://api.uat.anddone.com") : this()
        {
        ...
        {
            string report = "C# SDK (AndDoneSecureClientLibrary) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.3\n";
