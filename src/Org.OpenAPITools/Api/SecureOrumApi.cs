...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ISecureOrumApiSync : IApiAccessor
    {
        ...
        List<VerifyBankAccountResponse> SecureBankaccountsDetailsPost(string xApiKey, string xAppKey, float xVersion, string origin, float? id = default(float?), string? type = default(string?), VerificationEntityRequest? verificationEntityRequest = default(VerificationEntityRequest?), int operationIndex = 0);
        ...
        ApiResponse<List<VerifyBankAccountResponse>> SecureBankaccountsDetailsPostWithHttpInfo(string xApiKey, string xAppKey, float xVersion, string origin, float? id = default(float?), string? type = default(string?), VerificationEntityRequest? verificationEntityRequest = default(VerificationEntityRequest?), int operationIndex = 0);
        /// <summary>
    ...
    public interface ISecureOrumApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<VerifyBankAccountResponse>> SecureBankaccountsDetailsPostAsync(string xApiKey, string xAppKey, float xVersion, string origin, float? id = default(float?), string? type = default(string?), VerificationEntityRequest? verificationEntityRequest = default(VerificationEntityRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<VerifyBankAccountResponse>>> SecureBankaccountsDetailsPostWithHttpInfoAsync(string xApiKey, string xAppKey, float xVersion, string origin, float? id = default(float?), string? type = default(string?), VerificationEntityRequest? verificationEntityRequest = default(VerificationEntityRequest?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// This API will request for account verification.
        /// </summary>
        /// <remarks>
    ...
    public partial class SecureOrumApi : ISecureOrumApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;VerifyBankAccountResponse&gt;</returns>
        public List<VerifyBankAccountResponse> SecureBankaccountsDetailsPost(string xApiKey, string xAppKey, float xVersion, string origin, float? id = default(float?), string? type = default(string?), VerificationEntityRequest? verificationEntityRequest = default(VerificationEntityRequest?), int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;VerifyBankAccountResponse&gt;</returns>
        public Org.OpenAPITools.Client.ApiResponse<List<VerifyBankAccountResponse>> SecureBankaccountsDetailsPostWithHttpInfo(string xApiKey, string xAppKey, float xVersion, string origin, float? id = default(float?), string? type = default(string?), VerificationEntityRequest? verificationEntityRequest = default(VerificationEntityRequest?), int operationIndex = 0)
        {
