...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class SecurePaymentBatchingApi : ISecurePaymentBatchingApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentBatchResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse<PaymentBatchResponse> SecureBatchesPostWithHttpInfo(string xApiKey, string xAppKey, float xVersion, string origin, int? startRow = default(int?), int? pageSize = default(int?), string? sortField = default(string?), bool? asc = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'xApiKey' is set
            if (xApiKey == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PaymentBatchResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentBatchResponse>> SecureBatchesPostWithHttpInfoAsync(string xApiKey, string xAppKey, float xVersion, string origin, int? startRow = default(int?), int? pageSize = default(int?), string? sortField = default(string?), bool? asc = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'xApiKey' is set
            if (xApiKey == null)
            {
