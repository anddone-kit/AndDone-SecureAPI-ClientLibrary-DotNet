...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ISecurePaymentIntentApiSync : IApiAccessor
    {
        ...
        PaymentIntentExpiresResponse SecurePaymentintentsExpirationsPost(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0);
        ...
        ApiResponse<PaymentIntentExpiresResponse> SecurePaymentintentsExpirationsPostWithHttpInfo(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0);
        /// <summary>
    ...
    public interface ISecurePaymentIntentApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PaymentIntentExpiresResponse> SecurePaymentintentsExpirationsPostAsync(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PaymentIntentExpiresResponse>> SecurePaymentintentsExpirationsPostWithHttpInfoAsync(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// This API is use to create Secure payment Intent.
        /// </summary>
        /// <remarks>
    ...
    public partial class SecurePaymentIntentApi : ISecurePaymentIntentApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PaymentIntentExpiresResponse</returns>
        public PaymentIntentExpiresResponse SecurePaymentintentsExpirationsPost(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentIntentExpiresResponse</returns>
        public Org.OpenAPITools.Client.ApiResponse<PaymentIntentExpiresResponse> SecurePaymentintentsExpirationsPostWithHttpInfo(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PaymentIntentExpiresResponse</returns>
        public async System.Threading.Tasks.Task<PaymentIntentExpiresResponse> SecurePaymentintentsExpirationsPostAsync(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PaymentIntentExpiresResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<PaymentIntentExpiresResponse>> SecurePaymentintentsExpirationsPostWithHttpInfoAsync(string xApiKey, string xAppKey, string xVersion, string origin, string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'xApiKey' is set
            if (xApiKey == null)
            {
