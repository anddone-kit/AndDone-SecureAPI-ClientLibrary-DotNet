...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class SecureOutboundPaymentsApi : ISecureOutboundPaymentsApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<OutboundPaymentImageResponseDTO> localVarResponse = VendorapiSecureOutboundpaymentsImagePostWithHttpInfo(xApiKey, xAppKey, xVersion, origin, paymentTimeLineRequestDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of OutboundPaymentImageResponseDTO</returns>
        public Org.OpenAPITools.Client.ApiResponse<OutboundPaymentImageResponseDTO> VendorapiSecureOutboundpaymentsImagePostWithHttpInfo(string xApiKey, string xAppKey, float xVersion, string origin, PaymentTimeLineRequestDto paymentTimeLineRequestDto, int operationIndex = 0)
        {
            // verify the required parameter 'xApiKey' is set
            if (xApiKey == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'xApiKey' when calling SecureOutboundPaymentsApi->VendorapiSecureOutboundpaymentsImagePost");
            }

            // verify the required parameter 'xAppKey' is set
            if (xAppKey == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'xAppKey' when calling SecureOutboundPaymentsApi->VendorapiSecureOutboundpaymentsImagePost");
            }

            // verify the required parameter 'origin' is set
            if (origin == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'origin' when calling SecureOutboundPaymentsApi->VendorapiSecureOutboundpaymentsImagePost");
            }

            // verify the required parameter 'paymentTimeLineRequestDto' is set
            if (paymentTimeLineRequestDto == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'paymentTimeLineRequestDto' when calling SecureOutboundPaymentsApi->VendorapiSecureOutboundpaymentsImagePost");
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<OutboundPaymentImageResponseDTO> localVarResponse = await VendorapiSecureOutboundpaymentsImagePostWithHttpInfoAsync(xApiKey, xAppKey, xVersion, origin, paymentTimeLineRequestDto, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OutboundPaymentImageResponseDTO)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<OutboundPaymentImageResponseDTO>> VendorapiSecureOutboundpaymentsImagePostWithHttpInfoAsync(string xApiKey, string xAppKey, float xVersion, string origin, PaymentTimeLineRequestDto paymentTimeLineRequestDto, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'xApiKey' is set
            if (xApiKey == null)
            {
