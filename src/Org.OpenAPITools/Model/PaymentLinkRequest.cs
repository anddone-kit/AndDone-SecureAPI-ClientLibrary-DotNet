...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PaymentLinkRequest : IValidatableObject
    {
        ...
        public PaymentLinkRequest(string merchantId = default(string), string title = default(string), float amount = default(float), string paymentDescription = default(string), List<PaymentLinkResponseCustomersInner> customers = default(List<PaymentLinkResponseCustomersInner>), string invoiceNumber = default(string), int expireBy = default(int), int expireIn = default(int), ExpireInUnitEnum expireInUnit = default(ExpireInUnitEnum), string expireOn = default(string), List<PaymentLinkResponseLineItemsInner> lineItems = default(List<PaymentLinkResponseLineItemsInner>), string shortDescription = default(string), ResponseTypeEnum? responseType = default(ResponseTypeEnum?), PaymentLinkResponseCallbackParameters callbackParameters = default(PaymentLinkResponseCallbackParameters), PaymentLinkRequestSettings settings = default(PaymentLinkRequestSettings), PaymentLinkTypeEnum? paymentLinkType = default(PaymentLinkTypeEnum?), bool saveForFuture = default(bool), List<PaymentIntentRequestSplitsInner> splits = default(List<PaymentIntentRequestSplitsInner>), string quoteKey = default(string), string accountNumber = default(string), ReferenceTypeEnum referenceType = default(ReferenceTypeEnum), string referenceNumber = default(string), string referenceKey = default(string), List<PaymentLinkRequestReferenceDataListInner> referenceDataList = default(List<PaymentLinkRequestReferenceDataListInner>), bool enablePremiumFinance = default(bool), bool suppressTechnologyFee = default(bool), float overrideTechnologyFee = default(float), PlatformSettlementStatusEnum? platformSettlementStatus = default(PlatformSettlementStatusEnum?), bool isPayInFull = default(bool), bool isPremiumFinancier = default(bool), PaymentIntentRequestPfr pfr = default(PaymentIntentRequestPfr), PfTypeEnum? pfType = default(PfTypeEnum?))
        {
            ...
            {
                throw new ArgumentNullException("paymentDescription is a required property for PaymentLinkRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("referenceNumber is a required property for PaymentLinkRequest and cannot be null");
            }
