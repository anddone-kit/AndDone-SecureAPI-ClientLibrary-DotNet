...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PFLitePaymentLinkRequest : IValidatableObject
    {
        ...
        public PFLitePaymentLinkRequest(string quoteKey = default(string), bool isPayInFull = default(bool), string title = default(string), string paymentDescription = default(string), float expireIn = default(float), ExpireInUnitEnum expireInUnit = default(ExpireInUnitEnum), List<PFLitePaymentLinkRequestReferenceDataListInner> referenceDataList = default(List<PFLitePaymentLinkRequestReferenceDataListInner>), PFLitePaymentLinkRequestCallbackParameters callbackParameters = default(PFLitePaymentLinkRequestCallbackParameters), List<PFLitePaymentLinkRequestCustomersInner> customers = default(List<PFLitePaymentLinkRequestCustomersInner>), PFLitePaymentLinkRequestSettings settings = default(PFLitePaymentLinkRequestSettings))
        {
