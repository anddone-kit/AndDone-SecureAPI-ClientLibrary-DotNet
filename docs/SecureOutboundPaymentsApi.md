...
> List&lt;OutboundPaymentTimelineResponseDTOInner&gt; VendorapiSecureOutboundPaymentsTimelinesPost (string xApiKey, string xAppKey, string xVersion, string origin, PaymentTimeLineRequestDto paymentTimeLineRequestDto)
...
> void VendorapiSecureOutboundpaymentsCancelPost (string xApiKey, string xAppKey, string xVersion, string origin, CancelPaymentRequestDTO cancelPaymentRequestDTO)
...
> PaymentDetailResponseDTO VendorapiSecureOutboundpaymentsDetailPost (string xApiKey, string xAppKey, string xVersion, string origin, PaymentRequestDetailDTO paymentRequestDetailDTO)
...
> PaymentResponseDto VendorapiSecureOutboundpaymentsPost (string xApiKey, string xAppKey, string xVersion, string origin, PaymentRequestDto paymentRequestDto)
