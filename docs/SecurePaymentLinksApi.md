...
> PaymentLinkExpiresResponse SecurePaymentlinksExpirationsPost (string xApiKey, string xAppKey, string xVersion, string origin, SecurePaymentLinkRequest? securePaymentLinkRequest = null)
...
> PaymentLinkResponse SecurePaymentlinksIdPut (string xApiKey, string xAppKey, string xVersion, string origin, string id, SecureUpdatePaymentLinkRequest secureUpdatePaymentLinkRequest)
