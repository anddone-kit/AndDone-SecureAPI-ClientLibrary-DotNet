...
> List&lt;VerifyBankAccountResponse&gt; SecureBankaccountsDetailsPost (string xApiKey, string xAppKey, string xVersion, string origin, decimal? id = null, string? type = null, VerificationEntityRequest? verificationEntityRequest = null)
...
> List&lt;VerifyBankAccountResponse&gt; SecureBankaccountsVerifyPost (string xApiKey, string xAppKey, string xVersion, string origin, VerifyBankAccountRequest? verifyBankAccountRequest = null)
