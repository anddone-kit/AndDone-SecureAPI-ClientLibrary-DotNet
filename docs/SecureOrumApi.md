...
> List&lt;VerifyBankAccountResponse&gt; SecureBankaccountsDetailsPost (string xApiKey, string xAppKey, float xVersion, string origin, float? id = null, string? type = null, VerificationEntityRequest? verificationEntityRequest = null)
...
namespace Example
{
    public class SecureBankaccountsDetailsPostExample
    {
        public static void Main()
        {
            ...
            var id = 8.14D;  // float? | The Bank Account Entity Id (optional) 
...
| **id** | **float?** | The Bank Account Entity Id | [optional]  |
