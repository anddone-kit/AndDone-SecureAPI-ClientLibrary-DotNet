...
3. Modify and run the following code:
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            var xVersion = 2.3D;  // float | x-version
            var origin = "origin_example";  // string | origin
            var PaymentIntentRequest = new PaymentIntentRequest(); // PaymentIntentRequest | Enter your Payment Intent Request payload here
...
## Documentation for Models
 ...
 - [Model.TransactionPaymentResponseAchTenderInfoCommissionType](docs/TransactionPaymentResponseAchTenderInfoCommissionType.md)
 ...
 - [Model.TransactionPaymentResponseRefundOrigin](docs/TransactionPaymentResponseRefundOrigin.md)
