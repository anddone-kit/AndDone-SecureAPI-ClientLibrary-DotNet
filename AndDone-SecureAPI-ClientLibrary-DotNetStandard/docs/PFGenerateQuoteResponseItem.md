...
------------ | ------------- | ------------- | -------------
**QuoteKey** | **float** | The key associated with the quote. | [optional] 
...
**Installments** | **float** | The number of installments. | [optional] 
...
**ESignResult** | [**PFGenerateQuoteResponseItemESignResult**](PFGenerateQuoteResponseItemESignResult.md) |  | [optional] 
